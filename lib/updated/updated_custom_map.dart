...
import 'package:testing_geojson/data/buildingCoord.dart';
import 'package:testing_geojson/data/coord3.dart';
import 'package:testing_geojson/data/coord4.dart';
...
class UpdatedCustomMap extends CustomPainter {
  ...
  void paint4dStructures(Canvas canvas, List structure, Size size,
      {bool doPaint = true}) {
    final Paint paintFill = Paint()
  ...
  void paintStreets(Canvas canvas, List street, Size size) {
    final Paint paintBorder = Paint()
      ..color = Colors.white
      ..strokeCap = StrokeCap.round
      ..strokeWidth = 0.5;
